...
class TeachingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teaching" do
    assert_difference('Teaching.count') do
      post teachings_url, params: { teaching: { course_by_prof_id: @teaching.course_by_prof_id, instructor_id: @teaching.instructor_id } }
    end
  ...
  test "should update teaching" do
    patch teaching_url(@teaching), params: { teaching: { course_by_prof_id: @teaching.course_by_prof_id, instructor_id: @teaching.instructor_id } }
